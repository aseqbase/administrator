...
$module->Items = array(
	...
	"Admin-3" => array("Name" => "TAGS", "Access" => \_::$User->AdminAccess, "Path" => "/admin/content/tags", "Image" => "tags"),
	"Admin-4" => array("Name" => "TEMPLATE", "Access" => \_::$User->AdminAccess, "Path" => "/admin/system/template", "Image" => "quote-left"),
