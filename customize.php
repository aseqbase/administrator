...
\_::$Info->MainMenus = array(
    array("Name" =>"DASHBOARD","Link"=>"/home", "Access" =>\_::$Config->AdminAccess, "Image" =>"/asset/symbol/home.png"),
    array("Name" =>"CONTENTS","Link"=>"/admin/content/contents", "Access" =>\_::$Config->AdminAccess, "Image" =>"/asset/symbol/document.png", "Items"=> array(
    ...
    array("Name" =>"USERS","Link"=>"/admin/user/users", "Access" =>\_::$Config->AdminAccess, "Image" =>"/asset/symbol/user.png", "Items"=> array(
    ...
    array("Name" =>"PLUGINS","Link"=>"/admin/plugin/plugins", "Access" =>\_::$Config->AdminAccess, "Image" =>"/asset/symbol/plugin.png", "Items"=> array(
    ...
    array("Name" =>"APPEARANCES","Link"=>"/admin/system/template", "Access" =>\_::$Config->AdminAccess, "Image" =>"/asset/symbol/dashboard.png", "Items"=> array(
    ...
    array("Name" =>"SYSTEMS","Link"=>"/admin/system/information", "Access" =>\_::$Config->AdminAccess, "Image" =>"/asset/symbol/operation.png", "Items"=> array(
